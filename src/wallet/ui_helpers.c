...
{
   lv_obj_set_style_opa(target, val, (lv_style_selector_t)0);
}
...
{
   ui_anim_user_data_t *usr = (ui_anim_user_data_t *)a->user_data;
   lv_obj_set_style_opa(usr->target, v, (lv_style_selector_t)0);
}
...
{
   ui_anim_user_data_t *usr = (ui_anim_user_data_t *)a->user_data;
   return lv_obj_get_style_opa(usr->target, (lv_style_selector_t)0);
}
